...
instance SerialiseKey Word256 where
  serialiseKey (Word256{word256hi, word256m1, word256m0, word256lo}) =
    ...
    where
      fromByteString :: LBS.ByteString -> RawBytes
      fromByteString =
            fromShortByteString
          . SBS.toShort
          . LBS.toStrict
  deserialiseKeyOrFail = error "deserialiseKeyOrFail: Word256" -- TODO
  ...
  serialiseKey x =
    ...
    where
      ...
      fromByteString =
          ...
          . SBS.toShort
          . LBS.toStrict
  deserialiseKeyOrFail = error "deserialiseKeyOrFail: Word64" -- TODO
